        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link link text-black display-4" href="/Checkindividual" aria-expanded="false">Thai</a>
              </li>
              <li class="nav-item">
                <a class="text display-4">|</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-black display-4" href="/CheckindividualEN" aria-expanded="false">English</a>
              </li></ul>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="name">
                            ...
                            <div class="dragArea row">
                                <div class="col-sm-6  form-group" data-for="name">
                                    ...
                                    <input type="Name" name="NAME_EN" data-form-field="NAME_EN"  class="form-control display-5" id="NAME_TH" placeholder="Specify Full name">
                                </div>
