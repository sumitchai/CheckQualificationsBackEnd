        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link link text-black display-4" href="/dataindividual" aria-expanded="false">Thai</a>
              </li>
              <li class="nav-item">
                <a class="text display-4">|</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-black display-4" href="/dataindividualEN" aria-expanded="false">English</a>
              </li></ul>
  ...
  <div class="mbr-form form-with-styler" style="padding : 40px">
    ...
    <div >
      ...
      <div class="input-group-btn item-right" style="float: right ; padding-right : 120px">
        <a href="{{ route('HtmlToPDF')}}?degree={{$x->DEGREE_ID}}&NAME_TH={{$x->NAME_TH}}" class="btn btn-form btn-success display-5" type="submit" target ="_blank"><span class="glyphicon glyphicon-save"></span>Download</a>
      </div>
      <br><br><br><br><br>
    </div>
  </div>
