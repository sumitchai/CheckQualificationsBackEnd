        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link link text-black display-4" href="/dataindividual" aria-expanded="false">ภาษาไทย</a>
              </li>
              <li class="nav-item">
...
<section >
  <div class="mbr-form form-with-styler" style="padding : 40px">
    ...
    <a href="/HtmlToPDF/{{$x->DEGREE_ID}}" class="btn btn-form btn-success display-5" type="submit" target ="_blank"><span class="glyphicon glyphicon-save"></span>ดาวน์โหลด</a>
    </div>
    <br><br><br><br><br>
    @endforeach   
